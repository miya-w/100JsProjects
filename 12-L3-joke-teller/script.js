...
function toggleButton(){
   button.disabled = !button.disables; 
} 
...
function tellMe(joke){
    VoiceRSS.speech({
        key:'9fdafce3e9044c2eb5af8fd25cf57bfb',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
async function getJokes(){
    let joke = '';
    const apiURL = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=racist,sexist&type=single';
    try{
...
audioElement.addEventListener('ended',toggleButtom);